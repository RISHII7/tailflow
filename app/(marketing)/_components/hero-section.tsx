...
import OpenAILogo from "@/public/companies/openai.png";
          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                >
                  Tailflow organizes conversations into channels with threads, is realtime, and uses
        ...
        <section className="bg-background pb-16 pt-16 md:pb-32">
          <div className="group relative m-auto max-w-5xl px-6">
            ...
            <div className="group-hover:blur-xs mx-auto mt-12 grid max-w-2xl grid-cols-4 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14">
              ...
              <div className="flex">
                <Image className="mx-auto h-4 w-fit dark:invert" src={KindeLogo} alt="Kinde Logo" />
              </div>
              <div className="flex">
                <Image
              ...
              <div className="flex">
                <Image className="mx-auto h-6 w-fit" src={OrpcLogo} alt="Orpc Logo" />
              </div>
              <div className="flex">
                <Image
